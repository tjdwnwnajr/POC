...
public class RopeGrabtest : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (InputManager.RopeWasPressed||InputManager.RopeIsHeld &&!PlayerStateList.isRope&&hand.canGrab)
        {          
    ...
    private void MoveToChain(bool moveUp)
    {
        ...
        {
            //Debug.Log("������ �����̴� ��. �ӵ�: " + swingTarget.linearVelocityX);
            return;
        }
